...
TEST_CASES_TRANSITION_BATCH_ROW_MAJOR += [
    *batchify(
    ...
    (
        ...
        True,
        1,
        np.asarray([[0, 1, 0, 0], [0, 0, 1, 0]], dtype=int),
        np.asarray([[2], [2]], dtype=int),
        np.asarray([[0, 1, 1, 0], [0, 0, 0, 0]], dtype=int),
        EpisodeStatus.TRUNCATED,
    ),
    (
        2,
    ...
    (
        ...
        True,
        1,
        np.asarray([[0, 0, 1, 0], [0, 0, 1, 0]], dtype=int),
        np.asarray([[2, 0], [2, 1]], dtype=int),
        np.asarray([[0, 0, 1, 0], [0, 0, 0, 0]], dtype=int),
        EpisodeStatus.TRUNCATED,
    ),
]
